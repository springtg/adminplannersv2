...
<script type="text/javascript">
    function del(Name){
        if(isrunning)return;
        console.log("Del category ↵ Call");
        var url="{{base_url()}}admin-planners/product/delcategory";
        var data={
            Name            :   Name
        }
        console.log(data);
    ...
    function add(){
        if(isrunning)return;
        console.log("Add category ↵ Call");
        var Name,Des;
        Name = $('#typeName').val();
        Des = $('#typeDes').val();
        var url="{{base_url()}}admin-planners/product/addcategory";
        var data={
            Name            :   Name,
            Des             :   Des
        }
