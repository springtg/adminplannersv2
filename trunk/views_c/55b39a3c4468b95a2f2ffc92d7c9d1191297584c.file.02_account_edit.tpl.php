<?php /* Smarty version Smarty-3.1.7, created on 2012-08-09 05:12:36
         compiled from "application\views\admin-planners\account\02_account_edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2141650220b57ea7ba3-99275528%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '55b39a3c4468b95a2f2ffc92d7c9d1191297584c' => 
    array (
      0 => 'application\\views\\admin-planners\\account\\02_account_edit.tpl',
      1 => 1344481950,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2141650220b57ea7ba3-99275528',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_50220b580d307',
  'variables' => 
  array (
    'configs' => 0,
    'au' => 0,
...
<?php if ($_valid && !is_callable('content_50220b580d307')) {function content_50220b580d307($_smarty_tpl) {?>
                            ...
                            <td>
                                <div>
                                    <input type="password" id="txt-pass" class="text-input" style="width: 150px"  
                                       value="<?php if ($_smarty_tpl->tpl_vars['configs']->value["checkauthority"]==1){?><?php echo $_smarty_tpl->tpl_vars['configs']->value["accountobj"]["password"];?>
<?php }else{ ?>******<?php }?>"/>
                                </div>
                            </td>
                        </tr>
...
;
                ...
                $("#jqxCbx_group").jqxComboBox({ 
                    selectedIndex: <?php echo $_smarty_tpl->tpl_vars['configs']->value["group_index"];?>
, source: source, 
...
').jqxCheckBox({ 
                    checked: <?php if (strrpos($_smarty_tpl->tpl_vars['configs']->value["accountobj"]["authority"],((";").($_smarty_tpl->tpl_vars['au']->value->name)).(";"))===false){?>false<?php }else{ ?>true<?php }?>,
