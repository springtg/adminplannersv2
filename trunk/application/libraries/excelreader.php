...
class CI_Excelreader {
    ...
    function colhidden($col, $sheet = 0) {
        return isset($this->colInfo[$sheet][$col]['hidden']) ? (bool) $this->colInfo[$sheet][$col]['hidden'] : FALSE;
    }
    ...
    function rowhidden($row, $sheet = 0) {
        return isset($this->rowInfo[$sheet][$row]['hidden']) ? (bool) $this->rowInfo[$sheet][$row]['hidden'] : FALSE;
    }
    ...
    function borderLeftColor($row, $col, $sheet = 0) {
        return isset($this->colors[$this->xfProperty($row, $col, $sheet, 'borderLeftColor')]) ? $this->colors[$this->xfProperty($row, $col, $sheet, 'borderLeftColor')] : NULL;
    }

    function borderRightColor($row, $col, $sheet = 0) {
        return isset($this->colors[$this->xfProperty($row, $col, $sheet, 'borderRightColor')]) ? $this->colors[$this->xfProperty($row, $col, $sheet, 'borderRightColor')] : NULL;
    }

    function borderTopColor($row, $col, $sheet = 0) {
        return isset($this->colors[$this->xfProperty($row, $col, $sheet, 'borderTopColor')]) ? $this->colors[$this->xfProperty($row, $col, $sheet, 'borderTopColor')] : NULL;
    }

    function borderBottomColor($row, $col, $sheet = 0) {
        return isset($this->colors[$this->xfProperty($row, $col, $sheet, 'borderBottomColor')]) ? $this->colors[$this->xfProperty($row, $col, $sheet, 'borderBottomColor')] : NULL;
    }
     ...
     */
    function __construct($store_extended_info = true, $outputEncoding = '') {
