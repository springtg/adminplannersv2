...
function product_reload(type){
    ...
    var surl=base_url+"daugia/sanpham/getlist/"+type+"/"+groupby+"//";
...
function restoreproduct(id){
    ...
    var surl=base_url+"daugia/sanpham/restore/"+id;
    var sdata={
            "id":id
    };
    jQuery.ajax({
...
function deleteproduct(id){
    ...
    var surl=base_url+"daugia/sanpham/delete/"+id;
    var sdata={
...
function statusProduct(id,status){
    var surl=base_url+"daugia/sanpham/changeStatus/"+id+"/"+status;
...
function load_product_detail(id){
    ...
    $(".detail-dialog-tab-content").hide();
    $('.id-detail-dialog-detail-tab-content').show();
    $('.id-product-detail').load(base_url+"daugia/sanpham/detail/"+id);
}
function huy(){
...
function process(action){
    ...
    var surl=base_url+"daugia/sanpham/saveProduct/"+action;
